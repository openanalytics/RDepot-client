    ...
    return {
      ...
      createRepository: async (
        ...
        if (body === null || body === undefined) {
          throw new RequiredError(
            'body',
            'Required parameter body was null or undefined when calling createRepository.'
          )
        }
      ...
      updateRepository: async (
        ...
        if (body === null || body === undefined) {
          throw new RequiredError(
            'body',
            'Required parameter body was null or undefined when calling updateRepository.'
          )
        }
        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await RRepositoryControllerApiAxiosParamCreator(
          configuration
        ).updateRepository(body, id, options)
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
