...
export const ApiV2NewsfeedEventControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllEvents(page?: number, size?: number, sort?: Array<string>, technology?: Array<string>, userName?: Array<string>, packageName?: Array<string>, packageVersion?: Array<string>, repositoryName?: Array<string>, eventType?: Array<string>, resourceType?: Array<string>, fromDate?: string, toDate?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ResponseDtoPagedModelEntityModelNewsfeedEventDto>>> {
            const localVarAxiosArgs = await ApiV2NewsfeedEventControllerApiAxiosParamCreator(configuration).getAllEvents(page, size, sort, technology, userName, packageName, packageVersion, repositoryName, eventType, resourceType, fromDate, toDate, options);
...
export const ApiV2NewsfeedEventControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllEvents(page?: number, size?: number, sort?: Array<string>, technology?: Array<string>, userName?: Array<string>, packageName?: Array<string>, packageVersion?: Array<string>, repositoryName?: Array<string>, eventType?: Array<string>, resourceType?: Array<string>, fromDate?: string, toDate?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<ResponseDtoPagedModelEntityModelNewsfeedEventDto>> {
            return ApiV2NewsfeedEventControllerApiFp(configuration).getAllEvents(page, size, sort, technology, userName, packageName, packageVersion, repositoryName, eventType, resourceType, fromDate, toDate, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
