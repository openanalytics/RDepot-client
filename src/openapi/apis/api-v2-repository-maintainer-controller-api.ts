    ...
    return {
      ...
      getMaintainer: async (
        ...
        if (id === null || id === undefined) {
          throw new RequiredError(
            'id',
            'Required parameter id was null or undefined when calling getMaintainer.'
          )
        }
        const localVarPath =
          `/api/v2/manager/r/repository-maintainers/{id}`.replace(
