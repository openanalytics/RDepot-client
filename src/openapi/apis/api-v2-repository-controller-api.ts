...
export const ApiV2RepositoryControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getAllRepositories: async (page?: number, size?: number, sort?: Array<string>, deleted?: boolean, technology?: Array<string>, published?: boolean, maintainer?: Array<string>, name?: string, search?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ApiV2RepositoryControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllRepositories(page?: number, size?: number, sort?: Array<string>, deleted?: boolean, technology?: Array<string>, published?: boolean, maintainer?: Array<string>, name?: string, search?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ResponseDtoPagedModelEntityModelRepositoryDto>>> {
            const localVarAxiosArgs = await ApiV2RepositoryControllerApiAxiosParamCreator(configuration).getAllRepositories(page, size, sort, deleted, technology, published, maintainer, name, search, options);
...
export const ApiV2RepositoryControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllRepositories(page?: number, size?: number, sort?: Array<string>, deleted?: boolean, technology?: Array<string>, published?: boolean, maintainer?: Array<string>, name?: string, search?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<ResponseDtoPagedModelEntityModelRepositoryDto>> {
            return ApiV2RepositoryControllerApiFp(configuration).getAllRepositories(page, size, sort, deleted, technology, published, maintainer, name, search, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class ApiV2RepositoryControllerApi extends BaseAPI {
     ...
     */
    public async getAllRepositories(page?: number, size?: number, sort?: Array<string>, deleted?: boolean, technology?: Array<string>, published?: boolean, maintainer?: Array<string>, name?: string, search?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<ResponseDtoPagedModelEntityModelRepositoryDto>> {
