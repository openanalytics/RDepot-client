...
export const PythonRepositoryControllerApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getAllPythonRepositories: async (deleted?: boolean, name?: string, page?: number, size?: number, sort?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/v2/manager/python/repositories`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const PythonRepositoryControllerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllPythonRepositories(deleted?: boolean, name?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<ResponseDtoPagedModelEntityModelPythonRepositoryDto>>> {
            const localVarAxiosArgs = await PythonRepositoryControllerApiAxiosParamCreator(configuration).getAllPythonRepositories(deleted, name, page, size, sort, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PythonRepositoryControllerApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllPythonRepositories(deleted?: boolean, name?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig): Promise<AxiosResponse<ResponseDtoPagedModelEntityModelPythonRepositoryDto>> {
            return PythonRepositoryControllerApiFp(configuration).getAllPythonRepositories(deleted, name, page, size, sort, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {number} id 
...
export class PythonRepositoryControllerApi extends BaseAPI {
     ...
     * @memberof PythonRepositoryControllerApi
     */
    public async getAllPythonRepositories(deleted?: boolean, name?: string, page?: number, size?: number, sort?: Array<string>, options?: AxiosRequestConfig) : Promise<AxiosResponse<ResponseDtoPagedModelEntityModelPythonRepositoryDto>> {
        return PythonRepositoryControllerApiFp(this.configuration).getAllPythonRepositories(deleted, name, page, size, sort, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @param {number} id 
